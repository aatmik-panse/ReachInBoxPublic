...
function CenterPage({ selectedThread }) {
        ...
        setSelectedMail([
          {
            id: 0,
            fromName: "Orlando",
            fromEmail: "orladom@gmail.com",
            toName: "Aatmik Panse",
            toEmail: "aatmikpanse@mail.com",
            subject: "New Product Launch",
            body: "I would like to introduce you to ReachInBox, a productized email service specifically tailored for startups.",
            sentAt: "2024-08-29T10:00:00Z",
          },
        ]);
      }
    };
  ...
  const senderName =
    selectedMail.length > 0 ? selectedMail[0].fromName : "Unknown";

  const senderEmail =
    selectedMail.length > 0 ? selectedMail[0].fromEmail : "unknown@mail.com";

  return (
    <div className="overflow-y-scroll no-scrollbar h-full">
      <div className="border-b-[1px] dark:border-[#33383F] border-[#E0E0E0] w-full flex justify-between px-8 py-4">
        <div>
          <div className="dark:text-white text-black text-lg">{senderName}</div>
      ...
      <div className="py-8 mx-8 relative flex justify-center items-center">
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          {" "}
          <div className="dark:bg-[#171819] bg-[#E0E0E0] px-4 py-1 rounded text-sm text-black dark:text-white">
            {" "}
            Today
          </div>
        </div>
      ...
      <div className="py-8 mx-8 relative flex justify-center items-center">
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          {" "}
          <div className="dark:bg-[#171819] bg-[#E0E0E0] text-black rounded dark:text-white px-4 py-1 text-sm flex items-center space-x-1">
            {" "}
