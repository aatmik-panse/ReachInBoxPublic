...
function AllInbox({ data, loadMail }) {
  ...
  return (
    <div className="border-r-[1px] bg-[#FAFAFA] dark:bg-black dark:border-[#33383F] border-[#E0E0E0] h-full overflow-y-scroll no-scrollbar">
...
function Mail({ fromEmail, subject, threadId, loadMail, date }) {
